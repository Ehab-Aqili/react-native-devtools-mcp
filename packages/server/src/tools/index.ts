...
import { registerStartNetworkCaptureTool } from "./start-network-capture.js";
import { registerGetNetworkRequestsTool } from "./get-network-requests.js";
import { registerStopNetworkCaptureTool } from "./stop-network-capture.js";
...
export function registerDomainTools(server: McpServer, ctx: ServerContext): void {
  ...
  registerStartNetworkCaptureTool(server, ctx);
  registerGetNetworkRequestsTool(server, ctx);
  registerStopNetworkCaptureTool(server, ctx);
